                            ...
                            :AbstractPatternView(parent,channels,scale)
{
    ...
    m_colorDefault = m_ColorInstrument = m_ColorEffect = m_ColorParameter = m_ColorVolume = m_colorEmpty = QColor(152,148,144);
...
void ScreamTracker3PatternView::paintAbove(QPainter* painter, int height, int currentRow)
{
    ...
    //corners
    QString imagepath = QApplication::applicationDirPath() + QDir::separator() + "data/resources" + QDir::separator() + "trackerview" + QDir::separator() + "s3m_top.png";
