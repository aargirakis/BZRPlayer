...
HivelyTrackerPatternView::HivelyTrackerPatternView(Tracker *parent, const unsigned int channels)
...
void ::HivelyTrackerPatternView::paintTop(QPainter *painter, Info *info, unsigned int m_currentPattern,
    ...
    QString imagepath = MainWindow::resourcesTrackerViewPath + "/hively_top.png";
...
void HivelyTrackerPatternView::drawVuMeters(QPainter *painter) {
    ...
    for (int unsigned i = 0; i < t->info->numChannels; i++) {
        ...
        const int vuMeterCurrentHeight = volume * m_vuMeterHeight / 100;

        m_linearGrad = QLinearGradient(QPointF(0, m_vuMeterHeight - vuMeterCurrentHeight), QPointF(0, m_vuMeterHeight));
        m_linearGradHiLite = QLinearGradient(QPointF(0, m_vuMeterHeight - vuMeterCurrentHeight),
                                             QPointF(0, m_vuMeterHeight));
        m_linearGradDark = QLinearGradient(QPointF(0, m_vuMeterHeight - vuMeterCurrentHeight),
                                           QPointF(0, m_vuMeterHeight));
