                            ...
                            :AbstractPatternView(parent,channels,scale)
{
    ...
    m_colorDefault = m_ColorInstrument = m_ColorEffect = m_ColorParameter = m_ColorVolume = m_colorEmpty = QColor(69,154,73);
...
QString ImpulseTrackerPatternView::effect(BaseRow* row)
{
    ...
    switch (row->effect+1)
    {
        ...
        case  2:  effectStr = "F";break;
        case  3:  effectStr = "E";break;
        case  4:  effectStr = "G";break;
        case  5:  effectStr = "H";break;
        case  6:  effectStr = "L";break;
        case  7:  effectStr = "K";break;
        case  8:  effectStr = "R";break;
        case  9:  effectStr = "X";break;
        case 10:  effectStr = "O";break;
        case 11:  effectStr = "D";break;
        case 12:  effectStr = "B";break;
        case 14:  effectStr = "C";break;
        case 15:  effectStr = "S";break;
        case 16: effectStr = "A";break;
        case 17:  effectStr = "V";break;

        case 20: effectStr = "S";break;
        case 21: effectStr = "M";break;
        case 22: effectStr = "N";break;
        case 23:  effectStr = "X";break;
        case 24:  effectStr = "W";break;
        case 26: effectStr = "U";break;
        case 27:  effectStr = "X";break;
        case 28:  effectStr = "Q";break;
        case 29: effectStr = "P";break;
        case 30:  effectStr = "I";break;
        case 31: effectStr = "Y";break;
        case 37: effectStr = m_emptyEffect;break;

        case 133: effectStr = "Z";break;
        case 136: effectStr = "T";break;



        case 172: effectStr = "T";break;

        case 181: effectStr = "J";break;
        default: effectStr="???";break;
