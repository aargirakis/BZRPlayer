...
void Composer669PatternView::paintAbove(QPainter* painter, int height, int currentRow)
{
    ...
    QString imagepath = QApplication::applicationDirPath() + QDir::separator() + "data/resources" + QDir::separator() + "trackerview" + QDir::separator() + "composer669_top.png";
...
QString Composer669PatternView::effect(BaseRow* row)
{
    ...
    switch (row->effect)
    {
        case 121: effectStr = "a";break;
        case 120: effectStr = "b";break;
        case 122: effectStr = "c";break;
        case 166: effectStr = "d";break;
        case 123: effectStr = "e";break;
        case 126: effectStr = "f";break;
        default: effectStr = m_emptyEffect;break;
    }
    return effectStr;
}
QString Composer669PatternView::parameter(BaseRow* row)
{
    ...
    if(row->effect==166)
    {
        switch (parameter)
        {
            case 0x90: parameter = 1;break;
            case 0xa0: parameter = 2;break;
            case 0xb0: parameter = 3;break;
            case 0xc0: parameter = 4;break;
            case 0xd0: parameter = 5;break;
            case 0xe0: parameter = 6;break;
            case 0xf0: parameter = 7;break;
            case 0x00: parameter = 8;break;
            case 0x10: parameter = 9;break;
            case 0x20: parameter = 10;break;
            case 0x30: parameter = 11;break;
            case 0x40: parameter = 12;break;
            case 0x50: parameter = 13;break;
            case 0x60: parameter = 14;break;
            case 0x70: parameter = 15;break;
            case 0x80: parameter = 0;break;
        }
    }
