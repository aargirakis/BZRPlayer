...
cmake_policy(SET CMP0177 OLD) #TODO fix
...
if (WIN32)
    ...
    install(FILES ${LIB_FMOD_DIR}/${LIB_FMOD}
    ...
    set(LIB_FMOD_REALNAME "${LIB_FMOD_SONAME}.27") #TODO

    install(FILES
            ${LIB_FMOD_DIR}/${LIB_FMOD_SONAME}
            ${LIB_FMOD_DIR}/${LIB_FMOD_REALNAME}
            DESTINATION ${OUTPUT_DIR}/${LIB_DIR})
endif ()
