...
set(LIB_NAME "qt-advanced-docking-system")
set(LIB_VERSION "4.0.4")
set(LIB_NAME_VERSIONED "${LIB_NAME}-${LIB_VERSION}")
set(LIB_NAME_VERSIONED2 "Qt-Advanced-Docking-System-${LIB_VERSION}")
set(LIB_FILENAME "${LIB_NAME_VERSIONED2}.zip")
set(LIB_FILENAME_URL "${LIB_VERSION}.zip")
set(LIB_URL "https://github.com/githubuser0xFFFF/${LIB_NAME}/archive/refs/tags/${LIB_FILENAME_URL}")
...
download_patch_and_cmake(
        ${LIB_NAME} ${LIB_NAME_VERSIONED} ${LIB_FILENAME} ${LIB_URL} ${LIB_SHA_256_HASH} true ${LIB_UNPACKED_DIR}
