...
!macro DetectRunningBzr2
  ...
  MessageBox MB_OK|MB_ICONEXCLAMATION "Unable to detect if ${NAME} is running. Make sure it is closed before proceeding" /SD IDOK
...
Function .onGUIEnd
  ...
  ${if} $isRunButtonChecked == 1
    ...
    System::Call "User32::SetForegroundWindow(i) b ($0)" #TODO
  ${EndIf}
FunctionEnd
