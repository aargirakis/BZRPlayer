...
main() {
  ...
  mime_types_supported=(
    ...
    audio/x-sc2 audio/x-sc68 audio/x-scl audio/x-scn audio/x-sidmon audio/x-sndh audio/x-sonix audio/x-soundmon
    audio/x-spc audio/x-spl audio/x-stk audio/x-stm audio/x-sun audio/x-sunvox audio/x-symmod audio/x-tfmx
    audio/x-tfmx-st audio/x-umx audio/x-v2m audio/x-vgm audio/x-vorbis+ogg audio/x-xad audio/x-xm
  )
