...
FMOD_CODEC_DESCRIPTION klystroncodec =
{
    FMOD_CODEC_PLUGIN_VERSION,
    "FMOD Klystron plugin",// Name.
...
FMOD_RESULT F_CALLBACK klystronopen(FMOD_CODEC_STATE *codec, FMOD_MODE usermode, FMOD_CREATESOUNDEXINFO *userexinfo)
{
    ...
    klystron->klystronwaveformat.lengthpcm    = (KSND_GetPlayTime(klystron->song, numPatternRows)/1000.0)*klystron->klystronwaveformat.frequency;
