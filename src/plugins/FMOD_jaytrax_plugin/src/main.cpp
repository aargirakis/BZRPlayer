...
FMOD_RESULT F_CALLBACK getlength(FMOD_CODEC_STATE *codec, unsigned int *length, FMOD_TIMEUNIT lengthtype)
{
    ...
    {
        *length = (jaytrax_getLength(jaytrax->jay,jaytrax->jay->subsongNr,1,jaytrax->jaytraxwaveformat.frequency)/jaytrax->jaytraxwaveformat.frequency)*1000.0;
        cout << "length: " << jaytrax_getLength(jaytrax->jay,jaytrax->jay->subsongNr,1,jaytrax->jaytraxwaveformat.frequency) << "\n";
    }
    return FMOD_OK;
