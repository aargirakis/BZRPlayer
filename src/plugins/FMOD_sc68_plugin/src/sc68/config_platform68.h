...
#define HAVE_CONFIG_H //added by blazer
#ifdef HAVE_CONFIG_H
...
#ifdef _MSC_VER
# define HAVE_GETENV 1
//# define HAVE_ZLIB_H 1 //commented by bLAZER
# define BREAKPOINT68 __asm int 3
//# define vsnprintf _vsnprintf //commented by bLAZER
//# define vsprintf _vsprintf  //commented by bLAZER
# ifndef CDECL
