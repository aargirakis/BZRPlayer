...
#include <stdlib.h>
#include <string.h>
//#include "loaders/prowizard/prowiz.h" //commented out by blazer
#include "format.h"
...
//extern const struct format_loader it_loader; //commented out by blazer
...
const struct format_loader *const format_loader[] = {
	...
	&flt_loader,
	&st_loader,
	//&it_loader, //commented out by blazer
	&s3m_loader,
	&stm_loader,
	&stx_loader,
	&mtm_loader,
	...
	&emod_loader,
	&okt_loader,
	//&sfx_loader, //commented out by blazer
	&far_loader,
	&umx_loader,
	&stim_loader,
	&coco_loader,
