...
void org_decoder_mute_channel(org_decoder_t *decoder, size_t channel, bool mute); //added by blazer
int16_t org_decoder_vumeter_channel(org_decoder_t *decoder, size_t channel); //added by blazer
