...
FMOD_CODEC_DESCRIPTION gamecodec =
{
    ...
    FMOD_TIMEUNIT_MS|FMOD_TIMEUNIT_SUBSONG|FMOD_TIMEUNIT_TEMPO|FMOD_TIMEUNIT_MUTE_VOICE,					// The time format we would like to accept into setposition/getposition.
    &open,                           // Open callback.
