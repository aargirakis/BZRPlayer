...
#include <stdint.h>
#include <stdio.h>
#include "sidemu.h" //added by blazer
#include "sidplayfp/siddefs.h"
//#include "sidplayfp/sidversion.h" //commented out by blazer

class  SidConfig;
class  SidTune;
class  SidInfo;
class  EventContext;
class sidemu; //added by blazer
// Private Sidplayer
...
public:
	...
	//Added by blazer
    libsidplayfp::sidemu* getSid(unsigned int sidNum);
