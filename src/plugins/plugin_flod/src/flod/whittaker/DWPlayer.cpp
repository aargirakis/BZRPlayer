...
void DWPlayer::initialize()
{
    ...
    do {
        ...
        if (freqs) {
            position = freqs;
            voice->freqsPtr = base + readEndian(stream[position],stream[position+1]);position+=2;
        ...
        if (--voice->tick == 0) {
            ...
            do {
                ...
                if (value < 0) {
                    ...
                    if (value >= -32) {
                        ...
                        position--;
                        voice->volSpeed = stream[position];position++;
                        ...
                        case -127:
                            ...
                            voice->portaSpeed = (signed char)stream[position];position++;
                            voice->portaDelay = stream[position];position++;
                            voice->flags |= 2;
                            break;
                        case -126:
                        ...
                        case -124:
                            ...
                            break;
                        case -123:
                            if (m_variant) transpose = (signed char)stream[position];position++;
                            break;
                        case -122:
                            voice->vibrato = -1;
                            voice->vibSpeed = stream[position];position++;
                            voice->vibDepth = stream[position];position++;
                            voice->vibDelta = 0;
                            break;
                        case -121:
                            voice->vibrato = 0;
                        ...
                        case -120:
                            if (m_variant == 21) {
                                ...
                                fadeSpeed = stream[position];position++;
                            } else {
                                voice->transpose = (signed char)stream[position];position++;
                            }
                            break;
                        case -119:
                            if (m_variant == 21) {
                                ...
                                voice->trackPtr = base + readEndian(stream[position],stream[position+1]);position+=2;
                                voice->trackPos = 0;
                            }
                            break;
                        case -118:
                    ...
                    value = (readEndian(stream[position],stream[position+1]) * sample->relative) >> 10;position+=2;
            ...
            if (m_variant >= 20) {
                if (--voice->volCtr < 0) {
                    ...
                    vol = (signed char)stream[position];position++;
