...
void JBPlayer::initialize()
{
    ...
    do
    {
        ...
        voice->patternPos = readEndian(stream[position],stream[position+1]);position+=2;
    ...
    else
    {
                    ...
                    do {
                        ...
                        if (value < 0x80) {
                            ...
                            case 0x81:
                                ...
                                break;
                            case 0x82:
                                voice->portaStep = (signed char)stream[position];position++;
                                voice->portaPeriod = 0;
                                voice->portaCounter = stream[position];position++;
                                voice->flags |= 4;
                                break;
                            case 0x83:
                                voice->flags |= 136;
                            ...
                            case 0x85:
                                ...
                                temp = readEndian(stream[position],stream[position+1]);position+=2;
                                ...
                                break;
                            case 0x86:
                                voice->slideStep = stream[position];position++;
                                voice->slideValue = stream[position];position++;
                            ...
                            case 0x87:
                                ...
                                break;
                            case 0x88:
                                voice->periodMod = stream[position];position++;
                                break;
                            case 0x89:
                                position++;
                                break;
        ...
        do {
            ...
            if (voice->volume < 0xc0) {
                ...
                if (voice->volume < 0) {
                    position = vtrack + voice->volPointer;
                    value = stream[position] + voice->volPos;position++;
                    position = vblock + value;
                    voice->volume = stream[position];position++;
                    voice->volPos++;
                }
            }
            ...
            value = voice->slidePos + 1;
            position = pblock + value;
            temp = (signed char)stream[position];position++;
...
int JBPlayer::fx(JBVoice* voice, int value)
{
    ...
    case 1:
        ...
        break;
    case 2:
        voice->portaStep = (signed short)readEndian(stream[position],stream[position+1]);position+=2;
        voice->portaPeriod = 0;
        voice->portaCounter = stream[position];position++;
        voice->flags |= 4;
        break;
    ...
    case 10:
        ...
        break;
    case 11:
        waveLower = stream[position];position++;
        waveUpper = stream[position];position++;
        value = 1 + stream[position];position++;
        samples[1]->length = value;
        samples[1]->repeat = value;
        voice->sample1 = 1;
        break;
    case 12:
        voice->volumeMod = stream[position];position++;
        break;
    case 13:
        voice->flags |= 2;
        break;
    ...
    case 15:
        ...
        break;
    case 16:
        transpose = (signed char)stream[position];position++;
        break;
    case 17:
        voice->loopCounter = stream[position];position++;
    ...
    case 20:
        if (m_variant == 7) {
            speed = stream[position];position++;
            break;
        }
    case 21:
        voice->slidePointer = stream[position];position++;
        break;
    }
