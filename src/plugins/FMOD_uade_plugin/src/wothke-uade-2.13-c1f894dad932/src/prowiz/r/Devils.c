...
static unsigned int known_devils[] = {	// UADE
	0x2d8265e1,
	0x2dc355b7,
	0x536a751f,
	0x914d6625,
...
int16_t	 testDevils ( void )
{
  // UADE: failsave needed to avoid false positives
  if(!checkcrc(known_devils)) return BAD;	// UADE
...
/*
 *   DevilsReplay.c   2020-05 (c) Asle
 *
 * Converts packed MODs back to PTK MODs
 *
 * Source material is found at least in the following demos 
 * - No Reality
 * - Colors
