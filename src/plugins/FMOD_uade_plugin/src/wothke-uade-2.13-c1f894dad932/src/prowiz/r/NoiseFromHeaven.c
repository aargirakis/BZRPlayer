...
static unsigned int heaven[] = {	// UADE
	// since format uses specific "Fuck" file magic it might be save
	// enough to use without these..
	0x1085c32a,
	0x14b7df4c,
	0x21089eaf,
	0x41c0587f,
...
int16_t	 testNFH ( void )
{
  ...
  if(!checkcrc(heaven)) return BAD;	// UADE
