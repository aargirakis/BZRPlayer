...
static unsigned int unic1[] = {	// UADE
	0x166c33b2,
	0x1e0c9f7e,
	0x247a1b92,
	0x344bbe89,
...
// note: the song "UNIC.!!! mastercoma !!!" is not supported by the converter - but it plays in old UADE


int16_t	 testUNIC_withID ( void )
{
  // UADE: failsave needed to avoid false positives
  if(!checkcrc(unic1)) return BAD;	// UADE
