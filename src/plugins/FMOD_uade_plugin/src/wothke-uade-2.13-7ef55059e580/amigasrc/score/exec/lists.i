...
; WTF? how can the below impls be such utter garbage? names suggest that
; ADDTAIL could be meant to add to the end of the list and REMHEAD suggests
; that it gets the first entry from the list.. but for some reason REMHEAD
; retuns 0 even after ADDTAIL has just added an element to the list.. 
