...
; this should come from dos.i but something seems to be wrong with this shit assembler:
; error 68 in line 1 of "STRUCTURE": repeatedly defined symbol <DateStamp>
; so instead of using that include, I`ll just copy the constant def here..
