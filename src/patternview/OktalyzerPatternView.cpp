                            ...
                            :AbstractPatternView(parent,channels,scale)
{
    ...
    m_colorCurrentRowForeground = m_colorDefault = m_ColorRowNumber = m_ColorInstrument = m_ColorEffect = m_ColorParameter = m_ColorEffect2 = m_ColorParameter2 = m_ColorVolume = m_colorEmpty = QColor(17,153,238);
...
QString OktalyzerPatternView::effect(BaseRow* row)
{
    ...
    switch (row->effect)
    {
        case 112: effectStr = "A";break;
        case 113: effectStr =  "B";break;
        case 114: effectStr =  "C";break;
        case 156: effectStr =  "D";break;
        case 157: effectStr =  "H";break;
        case 117: effectStr =  "L";break; //117 for Z also?
        case 11: effectStr =  "P";break;
        case 15: effectStr =  "S";break;
        case 118: effectStr =  "U";break;
        case 12:
        case 174:
        case 10:
            effectStr =  "V";break;
        case 69: effectStr =  "W";break;
        case 110: effectStr =  "X";break;
        case 32: effectStr =  "Y";break;

        default: effectStr=QString::number(row->effect);break;
    }
    return effectStr;
}
