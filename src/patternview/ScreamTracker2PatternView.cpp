                            ...
                            :AbstractPatternView(parent,channels,scale)
{
    ...
    m_colorDefault = m_ColorRowNumber = m_ColorInstrument = m_ColorEffect = m_ColorParameter = m_ColorEffect2 = m_ColorParameter2 = m_ColorVolume = m_colorEmpty = QColor(168,168,168);
...
QString ScreamTracker2PatternView::effect(BaseRow* row)
{
    ...
    switch (row->effect)
    {
        case 15: effectStr = "A";break;
        case 11: effectStr = "B";break;
        case 13: effectStr = "C";break;
        case 10: effectStr = "D";break;
        case 2:  effectStr = "E";break;
        case 1:  effectStr = "F";break;
        case 3:  effectStr = "G";break;
        case 4:  effectStr = "H";break;
        case 0:  if(row->param>0) {effectStr = "J";} else {effectStr = m_emptyEffect;};break;
        default: effectStr="I";break; //The only missing official effect is I, I don't know the number for it though
    }
    return effectStr;
}
