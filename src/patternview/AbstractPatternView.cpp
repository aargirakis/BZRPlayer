...
AbstractPatternView::AbstractPatternView(Tracker *parent, unsigned int channels, int scale)
{
    ...
    m_ColorRowNumberCurrentRow = m_colorDefault = m_ColorRowNumber = m_ColorRowNumberHighLight = m_ColorInstrument = m_ColorEffect = m_ColorParameter = m_ColorEffect2 = m_ColorParameter2 = m_ColorVolume = m_colorEmpty = QColor(255,0,0);
    m_colorEmptyAlternate = m_colorDefaultAlternate = m_ColorInstrumentAlternate = m_ColorEffectAlternate = m_ColorEffect2Alternate = m_ColorParameterAlternate = m_ColorParameter2Alternate = m_ColorVolumeAlternate = QColor(255,255,0);
...
void AbstractPatternView::paintAbove(__attribute__((unused)) QPainter* painter,__attribute__((unused)) int height,__attribute__((unused)) int currentRow)
{

}

void AbstractPatternView::paintBelow(__attribute__((unused)) QPainter* painter,__attribute__((unused)) int height,__attribute__((unused)) int currentRow)
{
...
{
    //TODO räkna med firstchannelwidth annars blir all lite off efter första chan, tex multitracker
    //TODO räknas med sista så att går klicka på hela, tex. octamed 5
...
QString AbstractPatternView::instrument(BaseRow* row)
{
    ...
    instrumentStr = instrumentPad && instrumentStr.length()==1 ? m_instrumentPaddingCharacter + instrumentStr : instrumentStr;
