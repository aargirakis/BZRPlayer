    ...
    :AbstractPatternView(parent,channels,scale)
{
    ...
    volumeHex = true;
    rowNumberPad=true;
    m_colorDefault = m_ColorRowNumber = m_ColorInstrument = m_ColorEffect = m_ColorParameter = m_ColorEffect2 = m_ColorParameter2 = m_ColorVolume = m_colorEmpty = QColor(0,85,170);
