...
//added by blazer
unsigned int ModPlug_SampleSize(ModPlugFile* file,unsigned int qual)
{
	return file->mSoundFile.GetSample(qual)->nLength;
}
//added by blazer
unsigned int ModPlug_SampleLoopStart(ModPlugFile* file,unsigned int qual)
{
	return file->mSoundFile.GetSample(qual)->nLoopStart;
}
//added by blazer
unsigned int ModPlug_SampleLoopEnd(ModPlugFile* file,unsigned int qual)
{
	return file->mSoundFile.GetSample(qual)->nLoopEnd;
}
//added by blazer
signed char ModPlug_SampleFineTune(ModPlugFile* file,unsigned int qual)
{
	return file->mSoundFile.GetSample(qual)->nFineTune;
}
//added by blazer
unsigned short ModPlug_SampleVolume(ModPlugFile* file,unsigned int qual)
{
	return file->mSoundFile.GetSample(qual)->nVolume;
}
//added by blazer
bool ModPlug_Sample16Bit(ModPlugFile* file,unsigned int qual)
{
	return file->mSoundFile.GetSample(qual)->uFlags & CHN_16BIT;
}
//added by blazer
bool ModPlug_SampleStereo(ModPlugFile* file,unsigned int qual)
{
	return file->mSoundFile.GetSample(qual)->uFlags & CHN_STEREO;
}
//unsigned int ModPlug_InstrumentName(ModPlugFile* file,unsigned int qual,char* buff)
//{
//	return file->mSoundFile.GetInstrumentName(qual,buff);
//}
void ModPlug_SampleData(ModPlugFile* file,unsigned int qual,signed char* buff)
{
	file->mSoundFile.GetSampleData(qual,buff);
}
unsigned char ModPlug_GetChannelVUMeter(ModPlugFile* file, unsigned char* channels)
{
	return file->mSoundFile.GetChannelVUMeter(channels);
}